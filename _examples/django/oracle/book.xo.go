...
func (b *Book) Insert(ctx context.Context, db DB) error {
	...
	var id int64
	if _, err := db.ExecContext(ctx, sqlstr, b.Isbn, b.BookType, b.Title, b.Year, b.Available, b.BooksAuthorIDFkey, sql.Named("pk", sql.Out{Dest: &id})); err != nil {
		return err
	} // set primary key
	b.BookID = int64(id)
	// set exists
...
//
// Generated from index 'sys_c0011187'.
