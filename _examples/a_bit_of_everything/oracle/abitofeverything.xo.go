...
type ABitOfEverything struct {
	...
	ATimestampWithLocalTimeZone         Timestamp6WithLocalTimeZone `json:"a_timestamp_with_local_time_zone"`          // a_timestamp_with_local_time_zone
	ATimestampWithLocalTimeZoneNullable Timestamp6WithLocalTimeZone `json:"a_timestamp_with_local_time_zone_nullable"` // a_timestamp_with_local_time_zone_nullable
