...
func (o *Order) Insert(ctx context.Context, db DB) error {
	...
	if err := db.QueryRowContext(ctx, sqlstr, o.OrderID, o.CustomerID, o.EmployeeID, o.OrderDate, o.RequiredDate, o.ShippedDate, o.Freight, o.ShipName, o.ShipAddress, o.ShipCity, o.ShipRegion, o.ShipPostalCode, o.ShipCountry).Scan(&o.OrderID); err != nil {
		return logerror(err)
	}
	// set exists
	o._exists = true
...
func (o *Order) Delete(ctx context.Context, db DB) error {
	...
	const sqlstr = `DELETE FROM northwind.orders WHERE order_id = @p1`
	// run
