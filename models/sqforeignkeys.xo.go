...
// SqForeignKeys represents a row from ..
type SqForeignKeys struct {
	ID            int    // id
	Seq           int    // seq
...
// SqForeignKeysByTable runs a custom query, returning results as SqForeignKeys.
func SqForeignKeysByTable(db XODB, table string) ([]*SqForeignKeys, error) {
	var err error
